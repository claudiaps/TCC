...
tokens = ['92e8c1790640a59b6a4293f573a5bcad8ff61b2b', '76dae6711eb65e5c58f0c3997125576b9ff25e38', '839673a4314b5aa46c511105e57a7bef6c5320e2']
token_indice = 0
...
def get_data():
        ...
        try:
            ...
            for repo_name in repos:
                ...
                while(issue_number > -1):
                    try:
                        issue = repo.get_issue(issue_number)  # arrumar isso aqui
                        ...
                        iss = {
                            ...
                            'labels': [],
                            'n_comments': issue.raw_data['comments'],
    ...
    with open('../data/githubDataNextCloud.json', 'w') as outfile:
        json.dump(d, outfile)
